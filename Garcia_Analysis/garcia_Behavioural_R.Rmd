...
slope_data <- read.csv("D:/Aberdeen_Uni_June24/cap/THESIS/Basile_Garcia_Code/RetrieveAndCompareAnalysis-cleaning_VW/RetrieveAndCompareAnalysis-cleaning/data/stats/Fig2D_Garcia_SP.csv")
...
```{r}
#slope data from B. Garcia's code
slope_data <- read.csv("D:/Aberdeen_Uni_June24/cap/THESIS/Basile_Garcia_Code/RetrieveAndCompareAnalysis-cleaning_VW/RetrieveAndCompareAnalysis-cleaning/data/stats/Fig2D_Garcia_with_SP_with_Pie.csv")
