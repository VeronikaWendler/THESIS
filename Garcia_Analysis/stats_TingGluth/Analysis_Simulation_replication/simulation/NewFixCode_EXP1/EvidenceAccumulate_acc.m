...
function [Choice, RT, E, tempEyeData, FixAaLL, sumdvALL, FixDur]= EvidenceAccumulate_acc(OV,Vl,Vr,params)
...
%theta = beta3./beta2;
% z 
%s pbias = (2*z - 1) * a;       % if no bias, then z=0.5, and spbias simply 0
...
sumdvALL = cumsum(rv);      % + spbias ... with the z bias is added here when included in the model
