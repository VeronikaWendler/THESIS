...
% Loop and save each draw independently + fixed starting point for later reproduction
...
for d = 1:nDraws
    ...
    filename = sprintf(['D:/Aberdeen_Uni_June24/cap/THESIS/Garcia_Analysis/' ...
                        'stats_TingGluth/Analysis_Simulation_replication/simulation/FixSimulation_Study1/ppc_full_bayesian/sim_10_postdraws2' ...
...
function colIdx = safeFindCol(T, expectedName)
    ...
    if isempty(colIdx)
        error('Column %s not found', expectedName);
    end
end
