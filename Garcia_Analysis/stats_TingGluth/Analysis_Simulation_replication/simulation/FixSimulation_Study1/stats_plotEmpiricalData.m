...
empiricalPath = 'D:/Aberdeen_Uni_June24/cap/THESIS/OV_Analysis/stats_TingGluth/Analysis_Simulation_replication/simulation/NewFixCode_EXP1/Data/OVParticipants_Eye_Response_Feed_Allfix_addm_OV_Abs_CCT.csv';
simDir        = 'D:/Aberdeen_Uni_June24/cap/THESIS/Garcia_Analysis/stats_TingGluth/Analysis_Simulation_replication/simulation/NewFixCode_EXP1/ppc_full_bayesian/sim_1000_postdraws2';
nDraws        = 1000;
...
% table for later analsis in LLM
empRows = [];
for i = 1:nS
    for b = 1:5
