...
mode = 2  # 1 = filters fixations form start of trial until response (this is the fixation data I used exclusively)
...
#directory
bids_root = 'D:/Aberdeen_Uni_June24/cap/THESIS/Garcia_Analysis/data/'    # not sure why I called it bids - I sorted files in bids format but I didn't use that after all
...
# I know I am not making use of bids functionality here (intended to use it at first, but this code works as well)
                    ...
                    if current_trial_id is not None:
                        ...
                        if len(fixation_events) > 2:
                            ...
                            if left_dur > right_dur:
                                ...
                                mid_dom_loc, mid_dom_dur = 0, left_dur   # tie
                        else:
                                mid_dom_loc, mid_dom_dur = None, 0
                        ...
                        for line in asc:
                            ...
                            if feedback_off_match and current_trial_id:
                                ...
                                if feedback_start_time and fixation_events:
                                    ...
                                    trial_info["GazeDiff_Feed"] = abs(trial_info["DwellLeft_Feed"] - trial_info["DwellRight_Feed"])
